...
echo '<div class="mwb_prfw_list-review_container_wrapper">';
...
if ( $comment_details ) {
	foreach ( $comment_details as $k => $value ) {
		...
		?>
<div class="mwb_prfw_list-review_container_all">
	<ul class="mwb_prfw_list-review_container">
		<li class="mwb_prfw_list-review_content_head">
			<div class="mwb_prfw_list-review_content_head_content">
				<div class="mwb_prfw_list-review_content_head_img">
					<?php echo wp_kses_post( $avatar ); ?>

				</div>
				<div class="mwb_prfw_list-review_content_head_other">
					<div class="mwb_prfw_list-review_content_head_title">
					<?php echo esc_html( $author ); ?>

					</div>
					<div class="mwb_prfw_list-review_content_head_subtitle">
					<?php echo esc_html( $u_role ); ?>

					</div>
				</div>
			</div>
			<div class="mwb_prfw_list-review_content_star">
				<div class="mwb_prfw_list-review_content_star_icons">
		<?php
		for ( $i = 1; $i <= $rating; $i++ ) {
			?>
		...
		?>
				...
				<div class="mwb_prfw_list-review_content_star_count">
					<?php echo esc_html( $rating ) . ' / 5'; ?>
				</div>
			</div>
		</li>
		<li class="mwb_prfw_list-review_content_body">
			<div class="mwb_prfw_list-review_body_content">
				<p class="mwb_prfw_list-review_body_title">
				<?php
				if ( $prfw_title ) {
				...
				<div class="mwb_prfw_list-review_body_para mwb_prfw-review_body_para">
				<?php
				if ( $content ) {
					echo esc_html( $content );
				}
				?>
				<div class="mwb_prfw_extra-feature-list">
					<?php
		...
		<li class="mwb_prfw_list-review_content_footer">
			<div class="mwb_prfw_list-review_footer_content">
				<span class="mwb_prfw-review_footer_more">
					<?php esc_html_e( 'See More..', 'product-reviews-for-woocommerce' ); ?>
				</span>
				<div class="mwb_prfw_list-review_footer_reactions">
