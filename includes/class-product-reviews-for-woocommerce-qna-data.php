...
/**
 * Class Name Product_Reviews_For_Woocommerce_Qna_Data
 * This class will show the details of review-logs logs by extending WP_List_Table.
 */
class Product_Reviews_For_Woocommerce_Qna_Data extends WP_List_Table {
	 ...
	 * @param string $mwb_comment_status contains comment status.
	...
	protected function get_views() {
		...
		$link = add_query_arg(
			array(
				'page'  => 'product_reviews_for_woocommerce_menu',
				'prfw_tab'  => 'product-reviews-for-woocommerce-review-qna-display',
	...
	public function column_review( $comment ) {
		...
		if ( ( isset( $_GET['comment_status'] ) && ( 'all' === $_GET['comment_status'] ) ) || ( ! isset( $_GET['comment_status'] ) ) || ( isset( $_GET['comment_status'] ) && ( 'mine' === $_GET['comment_status'] ) ) ) {
			if ( 'approved' === $the_comment_status ) {
				$action = array(
					...
					'reply hide-if-no-js' => '<a href="javascript:void(0)" class="mwb_reply_comment_button" data-comment-type= "mwb_qa" data-post-id="' . $post_id . '" data-id="' . $comment->comment_ID . '">Reply</a>',
				...
				$action = array(
					...
					'reply' => '<a href="javascript:void(0)" class="mwb_reply_comment_button" data-comment-type= "mwb_qa" data-id="' . $comment->comment_ID . '">Reply</a>',
					'edit' => '<a href="' . get_edit_comment_link( $comment->comment_ID ) . '" data-id="' . $comment->comment_ID . '">Edit</a>',
					'spam' => '<a href="javascript:void(0)" class="spam_comment" data-id="' . $comment->comment_ID . '">Spam</a>',
					'trash' => '<a href="javascript:void(0)" class="trash_comment" data-id="' . $comment->comment_ID . '">Trash</a>',
				);
		...
		if ( isset( $_GET['comment_status'] ) && ( 'approved' === $_GET['comment_status'] ) ) {
			$action = array(
				'unapproved' => '<a href="javascript:void(0)" class="unapprove_data" data-id="' . $comment->comment_ID . '">Unapprove</a>',
				'reply hide-if-no-js' => '<a href="javascript:void(0)" class="mwb_reply_comment_button" data-post-id="' . $post_id . '" data-id="' . $comment->comment_ID . '">Reply</a>',
				'edit' => '<a href="' . get_edit_comment_link( $comment->comment_ID ) . '"  data-id="' . $comment->comment_ID . '">Edit</a>',
				'spam' => '<a href="javascript:void(0)" class="spam_comment" data-id="' . $comment->comment_ID . '">Spam</a>',
				'trash' => '<a href="javascript:void(0)" class="trash_comment" data-id="' . $comment->comment_ID . '">Trash</a>',
			);
		...
		if ( $this->user_can ) {
			?>
			<div id="inline-<?php echo esc_html( $comment->comment_ID ); ?>" class="hidden">
				...
				<div class="comment_status"><?php echo esc_attr( $comment->comment_approved ); ?></div>
			</div>
			<?php
		}
